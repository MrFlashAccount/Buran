...
| `src/constants.js` | `src/execution-runs/constants.js` | Durable state/schema constants stay core-owned. |
...
| `src/github-pr-transport-adapter.js` | `src/integrations/scm/github/pr-transport-adapter.js` | GitHub-specific transport isolated under SCM integration. |
...
| `src/pr-projection-adapter.js` | `src/workflow-boundary/pr-scm-projection/local-journal-adapter.js` | Provider-neutral local PR/SCM projection journal. |
| `src/projection-contract.js` | `src/workflow-boundary/pr-scm-projection/contract.js` | Generic PR/SCM projection contract. |
...
| `src/registry.js` | `src/execution-runs/registry/index.js` | Core registry boundary export surface. |
...
| `src/state-machine.js` | `src/execution-runs/state-machine.js` | Core transition rules. |
