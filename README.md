...
- no autonomous discovery, remote writes, implementation worker dispatch, checkout/worktree setup, fix-loop implementation, PR creation, or projection adapter.
