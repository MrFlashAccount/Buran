...
- no autonomous discovery, remote writes, implementation worker dispatch, checkout/worktree setup, fix-loop implementation, PR creation, or Slice 7 transport/GitHub write adapter.
